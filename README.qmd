...
model_names <- factor(c("Base", "AR1v1", "AR1v2", "ENP Calves", "Calves only", "Strandings only", "Calves/Strandings"), 
                        levels = c("Base", "AR1v1", "AR1v2", "ENP Calves", "Calves only", "Strandings only", "Calves/Strandings"),
